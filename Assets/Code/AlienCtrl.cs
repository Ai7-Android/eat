...
public class AlienCtrl : MonoBehaviour {
	...
	public Arrow _director = Arrow.Left;
	public Arrow _arrow;
	...
	private Vector3 getLocalTarget(){
		return this._alien.gameObject.transform.localPosition + getArrow ();
	...
	private Vector3 getWorldTarget(){
		...
		return this._alien.gameObject.transform.position + getArrow ();
	}
